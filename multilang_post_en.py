...
{events_block}"""
    ...
    if culture_block:
        culture_rule = f"""
8. If Sha Tin culture/climate notes are listed below, weave one sentence naturally and add a 【Sha Tin Culture & Climate】 block (2–3 bullets)
{culture_block}"""
...
6. Output publish-ready text only{events_rule}{culture_rule}
